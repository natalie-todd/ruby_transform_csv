...
- Email your solution as a .zip package to engineeringjobs@cirrusmd.com, include 'Software Engineer Take-Home'

### Transform Rules

- Trim extra white space for all fields
- Transform phone_numbers to E.164 format (All Numbers should be US e.g. +1)
- Transform ALL dates to ISO8601 format (YYYY-DD-MM)
